...
const Sidebar: React.FC<SidebarProps> = ({ collapsed = false }) => {
  ...
  return (
    <div className={cn(
      "h-full bg-sidebar flex flex-col py-4 border-r border-sidebar-border overflow-y-auto",
